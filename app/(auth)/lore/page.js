...
export default function LorePage() {
  ...
  // Global states:
  const { name, setName, characterClass, setCharacterClass, race, setRace, hometown, setHometown, hometownDescription, setHometownDescription } = useLore();
  // Local states:
	...
	return (
		<>
			...
			<section id="class" className="flex flex-col justify-center items-center gap-10 m-20">
			...
			<section id="town" className="flex flex-col justify-center items-center gap-10 m-28">
			...
			<section className="flex flex-col justify-center items-center gap-10 m-28">
				...
				<Button onClick={() => router.push("/chat")}>Start Adventure</Button>
			</section>
