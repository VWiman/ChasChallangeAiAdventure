  ...
  const hometowns = [
    {
      name: "Stoneholm",
      description:
        "Up high in the mountains, the crisp mountain air of Stoneholm whispers secrets of adventure",
    },
    {
      name: "Pineview",
      description: "A tranquil sanctuary nestled within ancient forests",
    },
    {
      name: "Marinport",
      description:
    ...
    },
    {
      name: "Eldorvik",
      description:
        "Nestled amidst mist-shrouded fjords, is a haven where ancient magic intertwines with rugged beauty",
    },
  ];
